                    ...
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('admin_slider_edit_submit',$slider->id) }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group mb-3">
                                    <label>Text</label>
                                    <textarea name="text"  class="form-control editor" cols="30" rows="10" style="color: black; text-color:black">{{ $slider->text }}</textarea>
                                </div>
                                <div class="form-group mb-3">
                                    <label>Button Text</label>
                                    <input type="text" value="{{ $slider->button_text }}" class="form-control" name="button_text">
                                </div>
                                <div class="form-group mb-3">
