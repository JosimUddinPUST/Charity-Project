                                ...
                                <tbody>
                                    @foreach ($sliders as $slider)
                                        <tr>
                                            ...
                                            <td>
                                                <img src="{{ asset('uploads/'.$slider->photo) }}" alt="No Image" class="w_200">
                                            </td>
                                            <td>
                                                {{ $slider->heading }}
                                            </td>
                                            <td class="pt_10 pb_10">
                                                ...
                                                <a href="{{ route('admin_slider_delete',$slider->id) }}" class="btn btn-danger btn-sm" onClick="return confirm('Are you sure?');"><i class="fas fa-trash"></i></a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
