        ...
        <div class="section-body">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('admin_volunteer_create_submit') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-group mb-3">
                                    <label>Detail</label>
                                    <textarea name="detail" class="form-control editor" cols="30" rows="10" style="color: black; text-color:black">{{ old('detail') }} </textarea>
                                </div>
