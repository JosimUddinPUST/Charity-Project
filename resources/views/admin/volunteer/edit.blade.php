                        ...
                        <div class="card-body">
                            <form action="{{ route('admin_volunteer_edit_submit',$volunteer->id) }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <div>
                                        <img src="{{ asset('uploads/'.$volunteer->photo) }}" alt="No Image" class="w_200">
                                    </div>
                                </div>
                                <div class="form-group mb-3">
                                ...
                                <div class="form-group mb-3">
                                    <label>Detail</label>
                                    <textarea name="detail" class="form-control editor" cols="30" rows="10" style="color: black; text-color:black">{{ $volunteer->detail }} </textarea>
                                </div>
